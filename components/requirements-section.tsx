...
export function RequirementsSection() {
  return (
    <section id="requisitos" className="py-16 bg-background mb-14 mt-10">
      <div className="container mx-auto px-4">
        ...
        {/* TEXTO DESCRIPTIVO */}
        <p className="text-center text-[#143B4D] text-[14px] md:text-[16px] lg:text-[30px] max-w-6xl mx-auto mb-16">
        ...
        <div className="grid md:grid-cols-3 gap-8 items-start max-w-6xl mx-auto mb-10">
          ...
          <div className="text-center">
            ...
            <Button className="bg-[#1A9CD9] hover:bg-[#1483ad] text-white rounded-full px-10 py-2 text-[16px] font-semibold">
              Solicitar préstamo
            </Button>
          </div>
        ...
        <div className="grid md:grid-cols-3 gap-8 items-start max-w-6xl mx-auto">
          ...
          <div className="text-center">
            ...
            <Button className="bg-[#99C137] hover:bg-[#8AB12F] text-white rounded-full px-10 py-2 text-[16px] font-semibold">
              Solicitar préstamo
            </Button>
          </div>
