...
export function RequirementsSection() {
  return (
    <section id="requisitos" className="py-16 bg-white mb-14 mt-10">
      <div className="container mx-auto px-4">
        ...
        {/* TEXTO DESCRIPTIVO */}
        <p className="text-center text-[#143B4D] text-[14px] md:text-[16px] lg:text-[30px] max-w-6xl mx-auto mb-26">
        ...
        <div className="grid md:grid-cols-3 gap-8 items-start max-w-6xl mx-auto mb-10">
          ...
          <div className="text-center">
            ...
            <h3 className="text-[20px] md:text-[22px] lg:text-[30px] font-bold text-[#363735] mb-3">
              Persona Individual
            </h3>
            <Button className="bg-[#1A9CD9] hover:bg-[#1483ad] text-white rounded-[13px] px-10 py-2 text-[22px] font-semibold">
              Solicitar préstamo
            </Button>
          </div>
          ...
          <div className="md:col-span-2">
            <div className="grid md:grid-cols-2 gap-8 text-[14px] md:text-[16px] lg:text-[20px] text-[#363735]">
              <ul className="space-y-6">
                <li className="flex gap-2">
                  <span className="text-[#143B4D]">•</span>
        ...
        <div className="max-w-6xl mx-auto border-t border-[#00AEEF] mb-20 mt-20" />

        {/* ---------- PERSONA JURÍDICA (MISMOS ESTILOS) ---------- */}
        <div className="grid md:grid-cols-3 gap-8 items-start max-w-6xl mx-auto">
          ...
          <div className="text-center">
            ...
            <Button className="bg-[#99C137] hover:bg-[#8AB12F] text-white rounded-[13px] px-10 py-2 text-[22px] font-semibold">
              Solicitar préstamo
            </Button>
          </div>
          ...
          {/* Columna derecha: listas */}
          <div className="md:col-span-2">
            <div className="grid md:grid-cols-2 gap-4 text-[14px] md:text-[16px] lg:text-[20px] text-[#363735]">
              <ul className="space-y-6">
                <li className="flex gap-2">
                  <span className="text-[#143B4D]">•</span>
